storage "consul" {
  ...
  service_address = "vault-client-3"
}

listener "tcp" {
  address     = "192.168.4.8:8200"
  tls_disable = "true"
  cluster_address = "192.168.4.8:8201"
...
api_addr = "http://vault-client-3:8200"
cluster_addr = "https://vault-client-3:8201"
